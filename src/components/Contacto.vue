<template>
  <div>
    <v-card class="pt-5">
      <v-form action="https://formsubmit.co/vegalu63@gmail.com" method="POST">
        ...
        <v-container>
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field
                label="Tipo de servicio que solicita"
                name="Tipo de servicio que solicita"
                v-model="tipo"
                :rules="tipoRules"
                required
                filled
          ...
          <input
            ...
            type="hidden"
            name="_next"
            value="https://luisvega.vercel.app/"
          />
...
export default {
  ...
  computed:{
    bloquear() {
      ...
      // return this.campos.nombre.trim() === "" ? true : false
    },
  },
  mounted() {},
  methods: {},
